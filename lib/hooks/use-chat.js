    ...
    const handleSubmit = (msg) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield openAi.createChatCompletion({
            ...
            onChunkReceived: (newMessages) => {
                ...
                const updatedMessagesWithContent = updatedMessages.map((message) => {
                    if (message.role === 'assistant' && message.isLoading) {
                        return Object.assign(Object.assign({}, message), { content: newMessages[0].content, isLoading: false });
                    }
                    return message;
                });
                setMessages(updatedMessagesWithContent);
            },
            onError: (error) => {
